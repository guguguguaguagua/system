...
<div class="div1">
    <div class="div2">
        <form action="registerServlet" onsubmit="return check()" method="post">
            <h2>Hi~ o(*￣▽￣*)ブ</h2><br>
            ${sessionScope.mess1}
            <p>账&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;号：<input type="text" name="UserNumber" placeholder="输入账号···" class="input1" required id="a1"></p><br>
            <p>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码：<input type="password" name="UserPassword" placeholder="数字或字母···" class="input1" required id="p1"></p><br>
            <p>确认密码：<input type="password" name="UserPassword1" placeholder="数字或字母···" class="input1" required id="p2"></p><br>
