                ...
                <ul>
                    ...
                    <li>
                        <label>
                            <i class="iconfont iconYYGK"></i>
                            <span>添加一个用户</span>
                            <button><a href="newUser.jsp" target="_self"></a></button>
                        </label>
                    </li>
                </ul>
            </li>
    ...
    <div class="body_right">
        <div class="table-wrapper">
            <table class="fl-table">
                ...
                <tbody>
                <form action="changeStationServlet" method="post">
                <tr>
                    <td><input type="text" name="StationNumber"></td>
                    <td><input type="text" name="StationName"></td>
                    <td><button type="submit" onclick="return confirm('您确定要修改么')">修改</button></td>
                </tr>
                </form>
                </tbody>
            </table>
