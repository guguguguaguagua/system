...
<meta charset="UTF-8">
<style type="text/css">
     #content{float: contour;width:780px;border:0px;text-align:center;}
     #logo{float: contour; no-repeat left bottom;}
        ...
        <table border="1" style="text-align: center" align="center" class="fl-table">
            ...
            <tr>
                ...
                <form action="deleteOrderServlet" method="post">
                    ...
                    <td><button type="submit" onclick="return  confirm('确定退票吗？') ">退票</button></td>
                </form>
