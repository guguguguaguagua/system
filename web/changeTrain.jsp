                ...
                <ul>
                    ...
                    <li>
                        <label>
                            <i class="iconfont iconYYGK"></i>
                            <span>添加一个站点</span>
                            <button><a href="newStation.jsp"></a></button>
                        </label>
                    </li>
                </ul>
            </li>
                ...
                <ul>
                    ...
                    <li>
                        <label>
                            <i class="iconfont iconYYGK"></i>
                            <span>添加一个车次</span>
                            <button><a href="newTrain.jsp"></a></button>
                        </label>
                    </li>
                </ul>
            </li>
                ...
                <ul>
                    <li>
                        <label>
                            <i class="iconfont iconYYGK"></i>
                            <span>修改管理员信息</span>
                            <button><a href="changeAdmin.jsp"></a></button>
                        </label>
                    </li>
                </ul>
            </li>
    ...
    <div class="body_right">
        <div class="table-wrapper">
            <table class="fl-table">
                ...
                <tbody>
                <form action="changeTrainServlet" method="post">
                <tr>
